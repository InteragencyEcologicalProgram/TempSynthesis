...
#I'll start with modeling the change in temperature from January to June

tempmean2.1 = dplyr::filter(tempmean2, julian <190)
tempmeansub = tempmean2.1[sample(nrow(tempmean2.1), 10000), ]
sp = tempmeansub
