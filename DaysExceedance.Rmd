...
speciesWide <- pivot_wider(newdf, names_from = Region, values_from = Presence)
```
...
(FishOpt2 <- ggplot(SpeciesYears2Opt) + 
   ...
   annotate(geom = "text", x = 1, y = 300, label = "20°C", size = 3) +
   annotate(geom = "text", x = 2, y = 300, label = "20°C", size = 3) +
   annotate(geom = "text", x = 3, y = 300, label = "20°C", size = 3) +
   annotate(geom = "text", x = 4, y = 300, label = "20°C", size = 3) +
   annotate(geom = "text", x = 5, y = 300, label = "20°C", size = 3) +
   annotate(geom = "text", x = 6, y = 300, label = "20°C", size = 3) +
   annotate(geom = "text", x = 7, y = 300, label = "20°C", size = 3) +
    theme_bw() + 
