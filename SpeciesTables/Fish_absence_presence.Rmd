...
#species <- rbind(vegclams, absence_presence_all)
# write_csv(species, "SpeciesTables/absence_presence_temp.csv")
```

Read in from here
```{r}
species <- read_csv("SpeciesTables/absence_presence_temp.csv")
...
```{r}
abprestable <- tiledataf %>% select(Common_name = Species, Taxon, Life_stage = LifeStage, Region, Season, Presence)
...
theme_tileplot <-  theme_bw() + 
  theme(panel.grid = element_blank(),
        ...
        axis.text.x = element_text(angle = 70, vjust = 0.5, color = "black"),
