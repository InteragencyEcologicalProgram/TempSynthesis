...
Save files
```{r}
save(newdatag21abin, newdatag25abin, newdatag25NRabin,  newdatag25NRabin, file = "newdataPreds_annualanomaly_20210713.RData")
```
...
Save raster files
```{r}
save(rastered_preds21abin, rastered_preds25abin, rastered_preds21NRabin, rastered_preds25NRabin, file = "RasteredPreds_20210713.RData")
```
...
plot21_avg <- raster_plot(rastered_preds21abin, 1) + ggtitle("Anomaly = 0")
plot21_anom <- raster_plot(rastered_preds21abin, 2) + ggtitle("Anomaly = 1")
...
```{r}
save( plot21NR_anom, plot21NR_avg, plot25NR_anom, plot25NR_avg, file = "finalplots_20210712.RData")

save(plot21_anom, plot21_avg, plot25_anom, plot25_avg, file = "finalplotsPart1_20210708.RData")
```
