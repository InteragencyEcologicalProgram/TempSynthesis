...
Calculate temperature anomaly: Calculate average temp over dataset. For each station, subtract annual mean temperature - 11-yr mean temperature
```{r}
...
Save files
```{r}
save(newdatag21abin, newdatag25abin, newdatag25NRabin,  newdatag25NRabin, file = "newdataPreds_20210629.RData")
```
...
Save raster files
```{r}
save(rastered_preds21abin, rastered_preds25abin, rastered_preds21NRabin, rastered_preds25NRabin, file = "RasteredPreds_20210629.RData")
```
...
plot21_anom <- raster_plot(rastered_preds21abin, 3) + ggtitle("propDays > 21 Anomaly = 2")
plot21_avg <- raster_plot(rastered_preds21abin, 2) + ggtitle("propDays > 21 Anomaly = 0")
#raster_plot(rastered_preds21abin, 1) + ggtitle("propDays > 21 Anomaly = -2")

plot25_anom <- raster_plot(rastered_preds25abin, 3) + ggtitle("propDays > 25 Anomaly = 2")
plot25_avg <- raster_plot(rastered_preds25abin, 2) + ggtitle("propDays > 25 Anomaly = 0")
#raster_plot(rastered_preds25abin, 1) + ggtitle("propDays > 25 Anomaly = -2")

pdf(file = "Figures/21NR_anom.pdf",   # The directory you want to save the file in
    width = 5, # The width of the plot in inches
    height = 6) # The height of the plot in inches
plot21NR_anom <- raster_plot(rastered_preds21NRabin, 3) + ggtitle("propDaysNoRecov > 21 Anomaly = 2")
plot21NR_anom
dev.off()
plot21NR_avg <- raster_plot(rastered_preds21NRabin, 2) + ggtitle("propDaysNoRecov > 21 Anomaly = 0")
#raster_plot(rastered_preds21NRabin, 1) + ggtitle("propDaysNoRecov > 21 Anomaly = -2")

plot25NR_anom <- raster_plot(rastered_preds25NRabin, 3) + ggtitle("propDaysNoRecov > 25 Anomaly = 2")
plot25NR_avg <- raster_plot(rastered_preds25NRabin, 2) + ggtitle("propDaysNoRecov > 25 Anomaly = 0")
#raster_plot(rastered_preds25NRabin, 1) + ggtitle("propDaysNoRecov > 25 Anomaly = -2")
```

```{r}
save(plot21_anom, plot21_avg, plot25_anom, plot25_avg, plot21NR_anom, plot21NR_avg, plot25NR_anom, plot25NR_avg, file = "finalplots_20210629.RData")
```
