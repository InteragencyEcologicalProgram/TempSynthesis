...
#### Create data
Is the n specific to lat/lon? Creating 300 lats and lons based on your specifications?
```{r}
# * normal ----
...
rastered_preds<-Rasterize_all(newdatag21abin, Prediction)

# Same for SE
rastered_SE<-Rasterize_all(newdatag21abin, SE)
```


Plot
```{r}
raster_plot2<-function(data, Anomaly, labels="All"){
  data = data[,,,Anomaly]
...
raster_plot2(rastered_preds, 3) + ggtitle("nDays > 21")
```
