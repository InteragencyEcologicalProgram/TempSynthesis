...
tempmean2 = start_event(tempmean2, column="Date", event=c("Station", "Year"), label.event="Event")
...
g5 =  bam(TempMax ~ s(julian, bs = "cc") +
            te(Latitude, Longitude), 
          data =tempmean2, method = "REML",  rho=r5, AR.start=tempmean2$start.event)
