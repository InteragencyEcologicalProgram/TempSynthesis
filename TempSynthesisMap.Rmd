...
map_final <- ggmap(map_obj) + 
  ...
  geom_sf(data = filter(WW_Delta,HNAME == "SAN JOAQUIN RIVER"), fill = "cadetblue1", colour = "cadetblue1", alpha = 0.6, inherit.aes = FALSE) +  
...
gg_inset_map1 = ggdraw() +
  draw_plot(map_final) +
  draw_plot(inset, x = 0.21, y = 0.68, width = 0.3, height = 0.3)
...
```{r}
gg_inset_map1
ggsave("Figures/StationMapInset3.tiff", width = 8, height = 8, device = 'tiff', dpi = 300, bg = "transparent")
