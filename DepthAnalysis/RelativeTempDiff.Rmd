...
##adjusting model
RelTempDiff_ANH = mutate(RelTempDiff_ANH, year2 = as.factor(Year))
RelTempDiff_ANH = filter(RelTempDiff_ANH, !is.na(TempDiffLag), !is.na(RelTempDiff), !is.na(TempDiffLag2))

## adding year as a factor
modelANH <- glm(RelTempDiff ~ sjulian + sHour + sjulian:sHour + TempDiffLag + year2 , data = RelTempDiff_ANH)
