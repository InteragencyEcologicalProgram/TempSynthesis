...
heatmapplot(maxAn1, maxTempAn, maxTempAn, 19, 35) #FarNorth
heatmapplot(maxAn2, maxTempAn, maxTempAn, 19, 35) #ND
heatmapplot(maxAn3, maxTempAn, maxTempAn, 19, 35) #SacR
heatmapplot(maxAn4, maxTempAn, maxTempAn, 19, 35) #SJ
heatmapplot(maxAn5, maxTempAn, maxTempAn, 19, 35) #South
heatmapplot(maxAn6, maxTempAn, maxTempAn, 19, 35) #SB
heatmapplot(maxAn7, maxTempAn, maxTempAn, 19, 35) #SM

heatmapplot(maxTemps, maxTempAn, maxTempAn, 19, 35) #All

##### Scaled heatmaps

# Kept scaling the same for all 3 plots so the three are comparable to each other
# By station
heatmapplot(maxAn1, maxTempAn_sta, maxTempAn,  -4.1, 4.1) #FarNorth
heatmapplot(maxAn2, maxTempAn_sta, maxTempAn,  -4.1, 4.1) #ND
heatmapplot(maxAn3, maxTempAn_sta, maxTempAn,  -4.1, 4.1) #SacR
heatmapplot(maxAn4, maxTempAn_sta, maxTempAn,  -4.1, 4.1) #SJ
heatmapplot(maxAn5, maxTempAn_sta, maxTempAn,  -4.1, 4.1) #South
heatmapplot(maxAn6, maxTempAn_sta, maxTempAn,  -4.1, 4.1) #SB
heatmapplot(maxAn7, maxTempAn_sta, maxTempAn,  -4.1, 4.1) #SM
...
heatmapplot(maxAn4, maxTempAn_yr, maxTempAn,  -4.1, 4.1)
heatmapplot(maxAn5, maxTempAn_yr, maxTempAn,  -4.1, 4.1)
heatmapplot(maxAn6, maxTempAn_yr, maxTempAn,  -4.1, 4.1)
heatmapplot(maxAn7, maxTempAn_yr, maxTempAn,  -4.1, 4.1)
...
# Make heat map
heatmapplotDays(hdaysComp1, ndays, ndays, 0, 150)
heatmapplotDays(hdaysComp2, ndays, ndays, 0, 150)
heatmapplotDays(hdaysComp3, ndays, ndays, 0, 150)
heatmapplotDays(hdaysComp4, ndays, ndays, 0, 150)
heatmapplotDays(hdaysComp5, ndays, ndays, 0, 150)
heatmapplotDays(hdaysComp6, ndays, ndays, 0, 100)
heatmapplotDays(hdaysComp7, ndays, ndays, 0, 100)
