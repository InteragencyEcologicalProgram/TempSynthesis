...
- Okay to include both WYType + Year (instead of WY, because then it conflicts?)
...
- Does it make sense to order the factors somehow for intercept and model interpretation?
...
Best Model: **M.max4 = glm(maxTemp~Region + I(Month^2) + WYType2_Sac +  WYType2_Sac:I(Month^2)**
```{r}
# Interactions?
...
# Temporal: Season vs. Month
summary(M.mean1 <- glm(meanTemp~Region + I(Month^2) + WYType2_Sac + Year, data = tempMonM))
