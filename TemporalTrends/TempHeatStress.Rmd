...
# By Region
ggplot(NoRecovery, aes(fWY, Region, fill = nDays)) + geom_tile() + scale_fill_viridis(option = "plasma") + theme_wtemp 

ggplot(NoRecovery, aes(fWY, Region, fill = propDays)) + geom_tile() + scale_fill_viridis() + theme_wtemp 
...
# By Region
ggplot(lowHeat, aes(fWY, Region, fill = nDays)) + geom_tile() + scale_fill_viridis(option = "plasma")+ theme_wtemp

ggplot(lowHeat, aes(fWY, Region, fill = propDays)) + geom_tile() + scale_fill_viridis() + theme_wtemp
...
# By Station
ggplot(NoRecovery, aes(fWY, Station, fill = nDays)) + geom_tile() + scale_fill_viridis(option= "plasma") + theme_wtemp + theme(axis.text.y = element_text(color = axisColor2)) 
