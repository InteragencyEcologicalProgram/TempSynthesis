...
tempDailyM <- readRDS(here("manuscript_code", "Data", "tempDaily.rds"))
LatLon <- read.csv(here("manuscript_code", "Data", "StationsMetadata.csv"))
regions <- st_read(here("manuscript_code", "RosiesRegionsEdited", "Rosies_regions_edited.shp"))
...
```{r}
gg_inset_map1
png("manuscript_code/Figures/station_map.png", width = 8, height = 8, units = "in", res = 300, pointsize = 9)
gg_inset_map1
dev.off()
