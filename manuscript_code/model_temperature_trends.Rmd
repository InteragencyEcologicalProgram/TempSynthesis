...
plotmax9 = plot(max9.emm, comparisons = TRUE, plotit = F, adjust = "bonferroni", alpha = 0.01)
results_max92 = cld(max9.emm, Letters = LETTERS, alpha = 0.01, p.adj.methods = "bonferroni") %>%
  left_join(plotmax9) %>%
