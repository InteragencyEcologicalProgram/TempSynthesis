...
tempdata <- readRDS(here::here("manuscript_code/Data/temp10yearsCalYr_20230613.rds")) 
names(tempdata)
#head (tempdata)
...
# png(filename=file13, units="in", type="cairo", bg="white", height=7, width=7, res=300, pointsize=10)
...
png(filename=file.path("manuscript_code/Figures/DegreeDays.png"), units="in",type="cairo", bg="white", height=5, 
