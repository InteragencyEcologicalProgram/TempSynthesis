...
summary_comb <- left_join(summary_all, summary_all0) %>%
  left_join(lengths) %>%
 dplyr::select(Species, Taxon, LifeStage, Length_mm, Length_type,
               `Lower Suboptimum Temperature Threshold (°C)`, 
               `Upper Suboptimum Temperature Threshold (°C)`, 
                `Lower Tolerance Temperature Threshold (°C)`, 
               `Upper Tolerance Temperature Threshold (°C)`, 
