...
```{r}
load("manuscript_code/Data/gam/finalplots_20230503.RData")
```
...
##### Final Stress plot
```{r}
png(filename=file.path("manuscript_code/Figures/StressPlot.png"), units="in",type="cairo", bg="white", height=6.5, 
...
```{r}
png(filename=file.path("manuscript_code/Figures/StressNRPlot_updated.png"), units="in",type="cairo", bg="white", height=3.5, 
     width=8, res=300, pointsize=10)
...
png(filename=file.path("manuscript_code/Figures/Anomaly25NRPlot_updated.png"), units="in",type="cairo", bg="white", height=4, 
     width=6, res=300, pointsize=10,compression="lzw")
