...
ggsave("manuscript_code/Figures/dendplot.png", device = "png", width = 11, height =9)
ggsave("manuscript_code/Figures/dendplot.tiff", device = "tiff", width = 11, height =9)
...
spas = st_join(st_transform(stashap, crs = st_crs(edsm)), edsm)
...
gp6c = ggplot() +
  ...
  geom_sf_label(aes(label = Regions), RosieReg, nudge_y = .1, nudge_x = 0.1) +
  geom_sf(data = delta, alpha = 0.5)+
