...
tempDaily10 <- readRDS(here::here("manuscript_code/Data/tempDaily_20210811.rds"))%>%
  mutate(Region = as.character(Region)) %>%
  mutate(Region = replace(Region, Region == "Sac River", "Confluence"),
         Region = replace(Region, Region == "San Joaquin", "Central"))
...
png(filename=file.path("manuscript_code/Figures/Figure_Regional_interannual_variance.tiff"), units="in",type="cairo", bg="white", height=5, 
